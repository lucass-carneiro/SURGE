#ifndef SURGE_GPU_BUMP_ARRAY_HPP
#define SURGE_GPU_BUMP_ARRAY_HPP
...
#ifdef SURGE_BUILD_TYPE_Debug
    gba.name = name;
    log_info("Creating GBA \"%s\" with size %li B redundancy %lu, totaling %li B", name,
...
#ifdef SURGE_BUILD_TYPE_Debug
    log_info("Destroying GBA \"%s\"", name);
#endif
...
#endif // SURGE_GPU_BUMP_ARRAY_HPP