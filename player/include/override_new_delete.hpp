/*
 * This is the original mimalloc-new-delete.h file with added Tracy profiling info
 */
...
-----------------------------------------------------------------------------*/
#pragma once
#ifndef SURGE_MIMALLOC_OVERRIDE_NEW_DELETE
#  define SURGE_MIMALLOC_OVERRIDE_NEW_DELETE
...
#endif // SURGE_MIMALLOC_OVERRIDE_NEW_DELETE