...
void mouse_left_click(cmdq_t &cmdq, const glm::vec2 &location) noexcept;
void mouse_scroll_up(cmdq_t &cmdq, const glm::vec2 &location) noexcept;
void mouse_scroll_down(cmdq_t &cmdq, const glm::vec2 &location) noexcept;
