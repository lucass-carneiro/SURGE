...
extern "C" SURGE_MODULE_EXPORT auto vk_on_load(surge::window::window_t) -> int { return 0; }

extern "C" SURGE_MODULE_EXPORT auto vk_on_unload(surge::window::window_t) -> int { return 0; }

extern "C" SURGE_MODULE_EXPORT auto vk_draw(surge::window::window_t) -> int { return 0; }

extern "C" SURGE_MODULE_EXPORT auto vk_update(surge::window::window_t, double) -> int { return 0; }
