...
// clang-format off
#include <mimalloc.h>
#include "mimalloc_override_new_delete.hpp"
// clang-format on
...
auto surge::allocators::eastl_allocators::gp_allocator::allocate(size_t n, int) const noexcept
    -> void * {
...
auto surge::allocators::eastl_allocators::gp_allocator::allocate(size_t n, size_t alignment, size_t,
...
void surge::allocators::eastl_allocators::gp_allocator::deallocate(void *p,
...
auto surge::allocators::eastl_allocators::gp_allocator::get_name() const noexcept -> const char * {
  return "mimalloc backed general porpouse EASTL allocator";
}

void surge::allocators::eastl_allocators::gp_allocator::set_name(const char *) {}

auto surge::allocators::eastl_allocators::operator==(const gp_allocator &,
                                                     const gp_allocator &) noexcept -> bool {
  return true;
}
