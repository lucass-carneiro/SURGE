...
enum Error : int {
  ...
  vk_cmd_buff_rec_end,
  vk_cmd_buff_submit,
  vk_cmd_immediate_fence_reset,
  vk_cmd_immediate_cmd_buff_reset,
  vk_cmd_immediate_cmd_buff_begin,
  vk_cmd_immediate_cmd_buff_end,
  vk_cmd_immediate_cmd_buff_submit,
  vk_cmd_immediate_cmd_buff_sync,
  vk_present,
